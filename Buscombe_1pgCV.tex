...
%    \begin{list2}
%        \vspace*{1mm}
%        \item Thesis title: {\sl Morphodynamics, Sediment Dynamics and Sedimentation of a Gravel Beach}. Advisor:  Prof. Gerhard Masselink.
%    \end{list2}
...
%    \begin{list2}
%        \vspace*{1mm}
%        \item Thesis title: {\sl Morphodynamics of a Ridge-and-Runnel System on a Macrotidal Beach}. Advisor:  Dr Suzanna Ilic.
%    \end{list2}
...
%    \end{list1}
    ...
    %{\bf University of Plymouth}, Plymouth, United Kingdom \vspace{2mm}\\\vspace{1mm}%
    {\bf September, 2008 -- present}. {\sl Computer Programming Contractor, Marine Biology \& Ecology Research Centre, University of Plymouth, UK.} %Underwater image perspective transformations and GUI development work for a team of deep-sea ecologists led by Dr Kerry Howell.
...
%	\item[3] {\sl American Geophysical Union Fall Meeting}, December 2007: Co-Convener on the following session: H60: Linking sediment supply, bed-sediment particle size, sediment transport, and bed morphology in fluvial, marine, and aeolian settings
%	\end{list1}
...
%	\item[2] Operating Systems: Linux (various Ubuntu and Fedora), Microsoft Windows (1998, XP, Vista, 7), Mac OSX.
%        \item[3] Distributed computing using Condor.
%        \item[4] Programming Languages: Matlab, shell scripting (proficient); Fortran, Python (experienced); HTML, C, R (beginner).
%        \item[5] Full UK driving licence.
%        \item[6] LANTRA sit-astride ATV qualification.
%        \item[7] Other interests: Phidgets (\url{http://www.phidgets.com/}), \LaTeX\
%    \end{list1}
...
%	\subsection{\mysidestyle Peer-Reviewed International Journals}
        \begin{footnotesize}
	\begin{list1}
...
%	\item[8] Williams, J., Masselink, G., {\bf Buscombe, D.}, Turner, I., Matias, A., Ferreira, O., Meltje, N., Bradbury, A., Albers, T., and Pan, S. (2009) BARDEX (Barrier Dynamics Experiment): taking the beach into the laboratory. {\sl Journal of Coastal Research} SI 56, 158-162.
	...
	\item[5] {\bf Buscombe, D.}, Rubin, D.M., and Warrick, J.A. (2010) Universal Approximation of Grain Size from Images of Non-Cohesive Sediment. {\sl Journal of Geophysical Research - Earth Surface} 115, F02015.

	\item[6] Williams, J.J., {\bf Buscombe, D.}, Masselink, G., Turner, I., and Swinkels, C. (2012) Barrier Dynamics Experiment (BARDEX): Aims, Design and Procedures. {\sl Coastal Engineering} 63, 3-12.

	\item[7] {\bf Buscombe, D.}, and Conley, D.C. (2012) Effective Shear Stress of Graded Sediment. {\sl Water Resources Research} 48, W05506.

	\item[8] {\bf Buscombe, D.}, and Rubin, D.M. (2012) Advances in the Simulation and Automated Measurement of Granular Material, Part 1: Simulations. {\sl Journal of Geophysical Research - Earth Surface} 117, F02001.

	\item[9] {\bf Buscombe, D.}, and Rubin, D.M. (2012) Advances in the Simulation and Automated Measurement of Granular Material, Part 2: Direct Measures of Particle Properties. {\sl Journal of Geophysical Research - Earth Surface} 117, F02002.
...
%	\item[15] {\bf Buscombe, D.}, Rubin, D.M., Lacy, J.R., Storlazzi, C., Sherwood, C., Hatcher, G., Chezar, H., and Wyland, R.. (in review) Seabed Dynamics on the Inner Continental Shelf: Insights from 18 Months of Hourly, High-Resolution Grain Size Measurements. {\sl Continental Shelf Research}
...
%	\item[17] {\bf Buscombe, D.} (in prep) Wavelet Method for Calibration-Free Estimates of Particle Size -Distribution from Images of Granular Material. Intended for {\sl GSA Bulletin}.

%	\item[18] {\bf 	Buscombe, D.}, Conley, D.C., and Nimmo-Smith, W.A.M. (in prep.) Acoustic and Holographic Measurements of Suspended Particles and Bubbles in the Surf Zone on a Sand Beach. Intended for {\sl Continental Shelf Research}
...
%	\item[20] Emlyn J. Davies, E.J., Graham, G.W., Nimmo-Smith, W.A.M., {\bf Buscombe, D.}, (in prep.), An evaluation of the performance of autonomous digital holographic image processing for characterising suspended particles, Intended for {\sl Measurement Science \& Technology}. 

	\end{list1}
        \end{footnotesize}
        

%	\subsection{\mysidestyle International Conferences}
%        \begin{footnotesize}
%	\begin{list1}
...
%	\item[22] {\bf Buscombe, D.}, and Conley, D.C. (2012) Schmidt number of sand suspensions under oscillating-grid turbulence. {\sl International Conference on Coastal Engineering}, Santander, July 2012.

%	\item[23] Conley, D.C., {\bf Buscombe, D.}, and Nimmo-Smith, A. (2012) Use of digital holographic cameras to examine the measurement and understanding of sediment suspension in the nearshore. {\sl International Conference on Coastal Engineering}, Santander, July 2012.

%	\item[24] Nimmo-Smith, A., {\bf Buscombe, D.}, and Conley, D.C. (2012) Use of digital holographic cameras to examine the measurement and understanding of sediment suspension in the nearshore. {\sl Particles in Europe}, Barcelona, October 2012.
...
%	\begin{list1}
%	 
%	\item[1] {\bf Digital Grain Size.} Software for automated analyses of grain size from images of sediment. Source code currently available in Matlab, Python, C, R, and Bash. Webpage \url{http://walrus.wr.usgs.gov/seds/grainsize/code.html}
%	\item[2] {\bf Benthic Analysis Tool.} Software for the semi-automation of species identification and measurement in deep-sea ROV/drop frame images. Source code available in Matlab.
%        \item[3] {\bf Sand Simulation Toolbox.} Software for generating 3D discrete particle models consisting of realistic particles (with a size- and shape-distribution) with user-defined properties. Source code available in Matlab.
%        \item[4] {\bf MATSCAT.} Software for analysis of multiple-frequency acoustic backscatter for suspended sediment concentration and particle size. Source code available in Matlab.
%      \item[5] Generic software for serial data acquisition and real-time display. Source code available in Python.
%        \item[6] Software for interfacing with machine-vision ethernet video cameras. Source code available in C.
...
%         \item[7] {\sl Centre for Coastal Science and Engineering, University of Plymouth}, 17th February 2009. Talk entitled `Turbulence, Sediment Stratification and Altered Resuspension under Waves'.
