...
\subtopic{\hspace*{-3ex} Forthcoming}{~
  ...
  \begin{itemize}[leftmargin=0ex, itemsep=0ex, parsep=.5ex, labelindent=-4ex]
    ...
    \publication
      ...
      {\sl Variability in high frequency acoustic backscattering by noncohesive sediment in shallow freshwater.} 
      JOURNAL OF THE ACOUSTICAL SOCIETY OF AMERICA, in preparation 2016

    \publication
      P.E. Grams {\sl et al.}
      {\sl Constructing a closed sediment budget in a noisy river.}
      GEOLOGY, in review 2016

    \publication
      D. Buscombe {\sl et al.}
      {\sl Effect of bubbles on acoustic measurements of suspended sand in the surf zone.}
      JOURNAL OF GEOPHYSICAL RESEARCH - OCEANS, in review 2016
...
\subtopic{\hspace*{-3ex} 2017}{~
  ...
  \begin{itemize}[leftmargin=0ex, itemsep=0ex, parsep=.5ex, labelindent=-4ex]
    ...
    \publication
      ...
      SEDIMENTOLOGY, 10.1111/sed.12338, accepted Oct 21. 2016
