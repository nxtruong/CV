...
\item[\mydot]
I am Assistant Research Professor at NAU, teaching and researching in sedimentology, sediment transport, geomorphology, and
...
\subtopic{\hspace*{-3ex} Forthcoming}{~
  ...
  \begin{itemize}[leftmargin=0ex, itemsep=0ex, parsep=.5ex, labelindent=-4ex]
    ...
    \publication
      ...
      JOURNAL OF GEOPHYSICAL RESEARCH - EARTH SURFACE, in preparation Jan. 2017

    \publication
      D. Buscombe \& P.E. Grams.
      {\sl Morphological and compositional signatures in acoustic backscatter over a mixed sand-gravel riverbed.} 
      JOURNAL OF GEOPHYSICAL RESEARCH - EARTH SURFACE, in preparation Jan. 2017

    \publication
      D. Buscombe {\sl et al.}
      {\sl Effect of bubbles on acoustic measurements of suspended sand in the surf zone.}
      JOURNAL OF GEOPHYSICAL RESEARCH - OCEANS, in preparation Jan. 2017

    \publication
      P.E. Grams {\sl et al.}
      {\sl Constructing a closed sediment budget in a noisy river.}
      GSA-BULLETIN, submission Feb. 2017
...
\subtopic{\hspace*{-3ex} 2016}{~
  ...
  \begin{itemize}[leftmargin=0ex, itemsep=0ex, parsep=.5ex, labelindent=-4ex]
    ...
    \publication
      ...
      SEDIMENTOLOGY, 10.1111/sed.12338, accepted Oct 2016
