...
\subtopic{\hspace*{-3ex} Forthcoming}{~
  ...
  \begin{itemize}[leftmargin=0ex, itemsep=0ex, parsep=.5ex, labelindent=-4ex]
    ...
    \publication
      D. Buscombe {\sl et al.}
      {\sl Semantic segmentation of images of coasts.}
    ...
    \publication
      D. Hamill {\sl et al.}
      {\sl Broad-scale mixed-alluvial substrate mapping by automated texture segmentation of recreational-grade side scan sonar imagery.}
      ENVIRONMENTAL MODELLING \& SOFTWARE, submission June 2017.

    \publication
      P.E. Grams {\sl et al.}
      {\sl Signal and noise in large-scale fluvial sediment budgets.}
      GEOMORPHOLOGY, submission June 2017.
