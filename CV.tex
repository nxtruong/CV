...
\lfoot{
  ...
  \,\hfill {\footnotesize \textcolor{gray}{updated December 2017~~~~~}} \hfill\,
}
...
\subtopic{\hspace*{-3ex} In Review}{~
  ...
  \begin{itemize}[leftmargin=0ex, itemsep=0ex, parsep=.5ex, labelindent=-4ex]
    ...
    \publication
      ...
      EARTH SURFACE PROCESSES \& LANDFORMS, submitted Nov 2017.
...
\subtopic{\hspace*{-3ex} Forthcoming}{~
  ...
  \begin{itemize}[leftmargin=0ex, itemsep=0ex, parsep=.5ex, labelindent=-4ex]
    ...
    \publication
      ...
      IEEE JOURNAL OF OCEANIC ENGINEERING, in preparation Dec 2017

    \publication
      D. Buscombe {\sl et al.}
      {\sl Effect of bubbles on acoustic measurements of suspended sand in the surf zone.}
      COASTAL ENGINEERING, in preparation Dec 2017

    \publication
      R. Tusso {\sl et al.}
      {\sl Bed Grain Size Measurements the Colorado River in Grand Canyon, Arizona, 2009 - 2017}.
      U.S. Geological Survey Open-File Report, in preparation Dec 2017
...
Grams, P.E., Buscombe, D. Topping, D.J., Mueller, E.R. (2017) Identification of discontinuous sand pulses on the bed of the Colorado River in Grand Canyon. 2017 AGU Fall Meeting, New Orleans, LA, 11-15 Dec.

Leary, K., Buscombe, D., Schmeeckle, M., Kaplinski, M. (2017) Assessing the Importance of Cross-Stream Transport in Bedload Flux Estimates from Migrating Dunes: Colorado River, Grand Canyon National Park. 2017 AGU Fall Meeting, New Orleans, LA, 11-15 Dec.

Platt, A. S., Buscombe, D., Porter, R. C., & Grams, P. (2017), Estimating Sediment Thickness from Riverbed to Bedrock within the Colorado River in the Grand Canyon. 2017 AGU Fall Meeting, New Orleans, LA, 11-15 Dec. 
