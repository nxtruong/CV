...
%	\item[16] {\bf Buscombe, D.}, Conley, D.C., and Rubin, D.M. (in prep.) Sorting on a sand beach alternating between intermediate and reflective states. Intended for {\sl Marine Geology}.
	...
	\item[39] {\bf Buscombe, D.}, in prep, Processing and georeferencing recreational-grade sidescan sonar data to support the democratization of acoustic imaging shallow water. {\sl LIMNOLOGY \& OCEANOGRAPHY: METHODS}\\
	
	\item[38] Grams, P.E. {\bf Buscombe, D.}, and others, in review, Patterns of channel and sandbar morphologic response to sediment evacuation in a debris-fan dominated canyon. Intended for {\sl EARTH SURFACE PROCESSES \& LANDFORMS}.\\
