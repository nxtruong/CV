...
%	\item[16] {\bf Buscombe, D.}, Conley, D.C., and Rubin, D.M. (in prep.) Sorting on a sand beach alternating between intermediate and reflective states. Intended for {\sl Marine Geology}.
	...
	\item[24] {\bf Buscombe, D.}, in prep., Creating georeferenced acoustic images of shallow benthic environments using recreational-grade sidescan sonar. Intended for {\sl ENVIRONMENTAL MODELLING \& SOFTWARE}\\
