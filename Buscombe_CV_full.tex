...
%    Modules on coastal, fluvial and glacial geomorphology
	...
	\item[20] {\bf Buscombe, D.}, Grams, P.E., Smith, S.M., in review, Automated riverbed sediment classification using low-cost sidescan sonar. {\sl Journal of Hydraulic Engineering}.\\

	\item[21] Davies, E.J., {\bf Buscombe, D.}, Graham, G.W., Nimmo-Smith, W.A.M., in review, Evaluating unsupervised methods to size and classify suspended particles using digital in-line holography, {\sl Journal of Atmospheric \& Oceanographic Technology}. \\

	\item[22] {\bf 	Buscombe, D.}, Conley, D.C., and Nimmo-Smith, W.A.M., in prep., Acoustic and Holographic Measurements of Suspended Particles and Bubbles in the Surf Zone on a Sand Beach. Intended for {\sl Marine Geology}
...
%	\item[16] {\bf Buscombe, D.}, Conley, D.C., and Rubin, D.M. (in prep.) Sorting on a sand beach alternating between intermediate and reflective states. Intended for {\sl Marine Geology}.
	...
	\begin{list1}
        \item[32] Grams. P.E., {\bf Buscombe, D.}, Topping, D.J., Hazel, J.E., and Kaplinski, M.A. (2015) Use of Flux and Morphologic Sediment Budgets for Sandbar Monitoring on the Colorado River in Marble Canyon, Arizona. {\sl 10th Federal Interagency Sedimentation Conference}, Reno, April 2015 (oral).\\

        \item[33] {\bf Buscombe, D.}, Grams. P.E., Kaplinski, M.A., Tusso, R.B., and Rubin, D.M. (2015) Hydroacoustic signatures of Colorado riverbed sediments in Marble and Grand Canyons using multibeam sonar. {\sl 10th Federal Interagency Sedimentation Conference}, Reno, April 2015 (oral).\\

        \item[34] {\bf Buscombe, D.}, Grams. P.E., Melis, T.S., Smith, S. (2015) Considerations for unsupervised riverbed sediment characterization using low-cost sidescan sonar: Examples from the Colorado River, AZ and the Penobscot River, ME. {\sl 10th Federal Interagency Sedimentation Conference}, Reno, April 2015 (oral).\\

        \item[35] Tusso, R.B., {\bf Buscombe, D.}, Grams. P.E. (2015) Using oblique digital photography for alluvial sandbar monitoring and low-cost change detection. {\sl 10th Federal Interagency Sedimentation Conference}, Reno, April 2015 (oral).
...
%    % Computer Skills
    ...
    \begin{list1}
        ...
        \item[5] Other interests: instrument control, machine vision, \LaTeX\, GUI development, machine learning, spectral analysis
    \end{list1}
     \end{footnotesize}
