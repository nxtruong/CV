...
%    % Conferences Organised
	...
	\item[4] {\sl American Geophysical Union Fall Meeting}, December 2013 (forthcoming): Co-Convener on the following session: EP010. Fluvial sediment budgets: Can we do better?
	\end{list1}
...
%    % Computer Skills
	...
	\item[2] Operating Systems: Linux (various Ubuntu and Fedora), Microsoft Windows (1998, XP, Vista, 7), Mac OSX.
        ...
        \item[5] Full UK driving licence. Arizona State driving licence. LANTRA sit-astride ATV qualification.
        \item[6] Other interests: Phidgets (\url{http://www.phidgets.com/}), instrument control, machine vision, \LaTeX\
    \end{list1}
...
%\end{footnotesize}
	...
	\item[14] Lacy, J.R., Rubin, D.M. and {\bf Buscombe, D.} (2012) Currents and sediment transport induced by a tsunami far from its source. {\sl Journal of Geophysical Research - Oceans} 117, C09028.
        ...
        \item[15] {\bf Buscombe, D.} (2013) Transferable Wavelet Method for Grain Size-Distribution from Images of Sediment Surfaces and Thin Sections, and Other Natural Granular Patterns. {\sl Sedimentology}, in press. DOI: 10.1111/sed.12049

	\item[16] {\bf Buscombe, D.}, Rubin, D.M., Lacy, J.R., Storlazzi, C., Sherwood, C., Hatcher, G., Chezar, H., and Wyland, R.. (in review) Seabed Dynamics on the Inner Continental Shelf: Insights from 18 Months of Hourly, High-Resolution Grain Size Measurements. {\sl Continental Shelf Research}

	\item[17] Emlyn J. Davies, E.J., Graham, G.W., Nimmo-Smith, W.A.M., {\bf Buscombe, D.}, (in prep.), An evaluation of the performance of autonomous digital holographic image processing for characterising suspended particles, Intended for {\sl Measurement Science \& Technology}. 
