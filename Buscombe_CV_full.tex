...
%	\item[16] {\bf Buscombe, D.}, Conley, D.C., and Rubin, D.M. (in prep.) Sorting on a sand beach alternating between intermediate and reflective states. Intended for {\sl Marine Geology}.
	...
	\item[39] {\bf Buscombe, D.}, submitted, Processing and georeferencing recreational-grade sidescan sonar data to support the democratization of acoustic imaging shallow water. {\sl ENVIRONMENTAL MODELLING \& SOFTWARE}\\
	...
	\subsection{\mysidestyle 2016}
	\begin{list1}
        \item[34] Rossi, R., {\bf Buscombe, D.}, Grams, P.E., and Wheaton, J.M. (2016) From Hype to an Operational Tool: Efforts to Establish a Long-Term Monitoring Protocol of Alluvial Sandbars using `Structure-from-Motion' Photogrammetry. {\sl American Geophysical Union Fall Meeting}, San Francisco, Dec 2016.\\        
